...
<div class="wbm-items">
    ...
    <div class="item-main">
        <div class="wbm-item-main">
          ...
          <p class="wbm-item-tit wbm-jl">项目预算：<span class="wbm-iname">${projectVo.priceRange}</span></p>
          <p class="wbm-item-tit wbm-jl">交付周期：<span class="wbm-iname">${projectVo.period}天</span></p>
          <p class="wbm-item-tit">竞标截止日期：<span class="wbm-iname">${projectVo.bidEndTime?string("yyyy-MM-dd HH:mm:ss")}</span></p>
          <p class="wbm-item-tit wbm-jl">需求详述：<span class="wbm-iname item-shows">${projectVo.content}</span></p>
          
            <div class="divider"></div>
            <p class="wbm-case"><a href="${viewUrl}">点此查看详情</a></p>
            <p class="wbm-cont">
            	在您联系客户时，请说明此项目来源于码客帮网站，谢谢配合！
            </p>      
            </div>
