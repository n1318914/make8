...
public class UpYun {
	...
	public boolean writeFile(String filePath, InputStream is, boolean auto, Map<String, String> params)
			throws IOException {
	...
	private String sign(HttpURLConnection conn, String uri, long length) {
		String sign = conn.getRequestMethod() + "&" + uri + "&" + conn.getRequestProperty(DATE) + "&"
				+ length + "&" + password;
		return "UpYun " + userName + ":" + MD5Util.encodeByMD5((sign));
	}
	...
	public static void main(String[] args) throws Exception{
		...
		upyun.setBucketName("piggif");
//		upyun.setFileSecret("zf91");
		upyun.setUserName("piggif");
		upyun.setPassword(MD5Util.encodeByMD5("piggif@123"));
		
		Map<String, String> paramsMap = new HashMap<String, String>();
		paramsMap.put(UpYun.PARAMS.KEY_X_GMKERL_QUALITY.getValue(), "75");// 图片压缩质量
		
		String filePath = "/upload/img/123.gif";

		upyun.writeFile(filePath, new File("http://img.soogif.com/Z1ExuaWuXmcw70HtvveCHcDLBNa9SI9p"), true, paramsMap);
	}
}
