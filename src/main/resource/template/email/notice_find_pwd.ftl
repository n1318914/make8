...
<body>
    <div class="wbm-find">
        <div class="wbm-findth">
            ...
            <p class="wbm-main1">尊敬的会员，您提交了找回密码申请,</p>
            <p class="wbm-main2">如果您没有提交修改密码的申请，请忽略本邮件,</p>
            <p class="wbm-main3">请点击下面的链接继续：</p>
            <div class="wbm-url">
                <a href="${activeUrl}"><p>${activeUrl}</p></a>
            </div>
            <p class="wbm-conpy">链接将在24小时内失效，如果你无法点击以上链接，请复制网址到浏览器中直接打开。</p>
            <a href="${activeUrl}"><button class="now-find">马上找回</button></a>
            </div>
