...
<html>
	<head>
		<meta charset="UTF-8">
		<title>码客帮 - 让靠谱的工程师为你开发 | 互联网软件众包平台 - ${provinceNode.name} ${cityNode.name} ${districtNode.name} </title>
		<meta name="keywords" content="码客帮, 软件外包, 软件众包, 代码众包, 开发者众包, 程序员兼职, 项目外包,互联网软件外包,网站外包,安卓APP外包,Andriod APP,iOS APP外包,微信开发外包,${provinceNode.name},${cityNode.name},${districtNode.name}">
    ...
    <script type="text/javascript" src="${ctx}/js/header.js?v=201504142230"></script>
		<link rel="stylesheet" href="${ctx}/css/infos/area.css"/>
	...
	<body>
		...
		<div class="body">
				...
				<div class="BreadcrumbNavigation">
					...
					<i class="fa fa-angle-right"></i>
					<a href="/infos/${provinceNode.urlId!""}/${cityNode.urlId!""}">${cityNode.name}</a>
					<i class="fa fa-angle-right"></i>
					<a>${districtNode.name}</a>
				</div>
				...
				<div class="region">
					<div>其他城区：</div>
					<ul>
						<#list otherDistrictNodes as otherDistrictNode>
							<li>
								<a href="/infos/${provinceNode.urlId!""}/${cityNode.urlId!""}/${otherDistrictNode.urlId!""}">
									${otherDistrictNode.name!""}
								</a>
							</li>
						</#list>
					</ul>
			...
			<div class="body_left">
				...
				<div class="content">
					<#list districtNode.items as item>
						<div class="article">
				...
				<ul>
					<#list siblingNodes as siblingNode>
						<li>
							...
							<a href="/infos/${provinceNode.urlId!""}/${cityNode.urlId!""}/${siblingNode.urlId!""}">
								${siblingNode.name}
							</a>
						</li>
					</#list>
